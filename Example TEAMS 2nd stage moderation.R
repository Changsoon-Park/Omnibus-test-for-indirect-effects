setwd("C:\\Users\\cspar\\Dropbox\\research files\\2024 group equality of indirect effects\\hayes2018data\\teams")
D=read.csv("teams.csv")
names(D)=c("X","M","EXP","Y")
...
text(F.origin+1, 0.2,paste0("p=",round(p.value,4)))
############ end ###################################