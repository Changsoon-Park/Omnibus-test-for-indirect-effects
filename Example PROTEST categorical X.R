library(lavaan)
setwd("C:\\Users\\cspar\\Dropbox\\research files\\2024 group equality of indirect effects\\hayes2018data\\protest")
D=read.csv("protest.csv")[,c(2,5,6)]  # D: Protest data from Hayes
names(D)=c("X","Y","M")
...
text(F.origin+0.8, 0.1,paste0("p=",round(p.value,4)))
################### end ################################
